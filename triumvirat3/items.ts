...
export const ITEM_CATALOG: Record<string, Item> = {
  "boss_ent_helm": {
    ...
    "rarity": "rare" as any,
    "price": 1000,
    "stats": {"hp":50,"defense": 3,"magicDefense": 2}
  },
  "boss_ent_armor": {
    "id": "boss_ent_armor",
    ...
    "rarity": "epic" as any,
    "price": 5000,
    "stats": {"hp":120,"defense": 5,"maxHp": 30}
  },
  "boss_ent_acc": {
    "id": "boss_ent_acc",
  ...
  "boss_ent_acc_leg": {
    ...
    "price": 25000,
    "stats": {"hp":28,"maxHp": 30,"defense": 30,"magicDefense": 4}
  },
  "wpn_req_war_1": {
    "id": "wpn_req_war_1",
  ...
  "wpn_req_mag_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"magicAttack": 15,"magicDefense": 20},
  ...
  "wpn_req_rog_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"attack": 13,"critRate":15,"agility":30},
    "allowedClasses": ["Разбойник","Ассасин"]
  },
  "wpn_req_arc_1": {
    "id": "wpn_req_arc_1",
  ...
  "wpn_req_pri_1": {
    ...
    "rarity": "uncommon" as any,
    "price": 2500,
    "stats": {"magicAttack": 6,"magicDefense": 20},
    "allowedClasses": ["Жрец"]
  },
  "wpn_req_pri_2": {
    "id": "wpn_req_pri_2",
  ...
  "wpn_req_pal_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"attack": 12,"magicAttack": 7,"defense": 15},
    "allowedClasses": ["Паладин"]
  },
  "wpn_req_dru_1": {
    "id": "wpn_req_dru_1",
  ...
  "wpn_req_dru_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"magicAttack": 11,"attack": 11},
  ...
  "wpn_req_bar_1": {
    ...
    "rarity": "uncommon" as any,
    "price": 2500,
    "stats": {"magicAttack": 5,"agility":20},
    "allowedClasses": ["Бард"]
  },
  "wpn_req_bar_2": {
    "id": "wpn_req_bar_2",
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"magicAttack": 11,"mp":150,"agility":40},
    "allowedClasses": ["Бард"]
  },
  "wpn_req_mon_1": {
    "id": "wpn_req_mon_1",
  ...
  "wpn_req_mon_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"attack": 13,"critRate":10,"agility":25},
    "allowedClasses": ["Монах","Боец"]
  },
  "wpn_req_nec_1": {
    "id": "wpn_req_nec_1",
  ...
  "wpn_req_nec_2": {
    ...
    "rarity": "epic" as any,
    "price": 15000,
    "stats": {"magicAttack": 16,"magicDefense":-20},
...
export function getItem(itemId: string): Item | undefined {
  ...
  const { baseId, slots, level, enhance } = parseItemId(itemId);
  ...
  if (cloned.stats && ['weapon', 'armor', 'helmet', 'shield', 'accessory'].includes(cloned.type)) {
     ...
     let budgetMult = 1.0;
     if (cloned.type === 'accessory') budgetMult = 0.5;
     else if (cloned.type === 'weapon') budgetMult = 0.6;
     
     // Magic weapons get higher base budget to compensate for splitting budget with MP
     const baseBudget = cloned.type === 'accessory' ? 1 : (isMagicWeapon ? 8 : 3);
     ...
     if (sumLinear > 0) {
         for (let k in cloned.stats) {
             if (!PERCENTAGE_STATS.includes(k) && typeof cloned.stats[k as keyof ItemStats] === 'number') {
                 ...
                 // Items grow based on their base values and rarity
     ...
     if (enhance > 0 && cloned.stats) {
         if (cloned.type === 'weapon') {
             if (cloned.stats.attack !== undefined) cloned.stats.attack += enhance;
             if (cloned.stats.magicAttack !== undefined) cloned.stats.magicAttack += enhance;
         } else if (cloned.type === 'armor' || cloned.type === 'shield' || cloned.type === 'helmet') {
             if (cloned.stats.defense !== undefined) cloned.stats.defense += enhance * 2;
             if (cloned.stats.magicDefense !== undefined) cloned.stats.magicDefense += enhance * 2;
         } else if (cloned.type === 'accessory') {
             if (cloned.stats.agility !== undefined) cloned.stats.agility += enhance;
             if (cloned.stats.hp !== undefined) cloned.stats.hp += enhance * 5;
             if (cloned.stats.maxHp !== undefined) cloned.stats.maxHp += enhance * 5;
         }
     }
  }
