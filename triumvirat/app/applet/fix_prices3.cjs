...
// let's just do a blanket replace for price of cons_4 just in case it didn't match
code = code.replace(/"name": "Эликсир Жизни",.*?price: 1500/gs, '"name": "Эликсир Жизни", "rarity": "epic", "healAmount": 1000, "price": 250,'); // "эликсир жизни стоит меньше среднего зелья" - wait, if medium is 100, elixir should be 250 or something. 
